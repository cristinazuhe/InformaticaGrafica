...
void FGE_PulsarTeclaNormal( unsigned char tecla, int x_raton, int y_raton )
{
   ...
   if( practica_activa ==3){
     if(toupper(tecla) != '+' && toupper(tecla) != '-' && toupper(tecla) != 'Q' 
                              && toupper(tecla) != GLUT_KEY_F1  && toupper(tecla) != GLUT_KEY_F2 && toupper(tecla) != GLUT_KEY_F4){   
   ...
   //cout << "tecla normal....." << frustum_factor_escala << endl ;
     ...
     if(toupper(tecla) != '+' && toupper(tecla) != '-' && toupper(tecla) != 'Q' 
                              && toupper(tecla) != GLUT_KEY_F1  && toupper(tecla) != GLUT_KEY_F2 && toupper(tecla) != GLUT_KEY_F3){   
...
void FGE_PulsarTeclaEspecial( int tecla, int x_raton, int y_raton )
{
   ...
   switch ( tecla )
   {
      ...
      case GLUT_KEY_F3:  //con f3 practica3
         practica_activa = 3;
         break;
      case GLUT_KEY_F4:  //con f4 practica4
         practica_activa = 4;
         break;
...
void Inicializar( int argc, char *argv[] )
{
   ...
   // inicializar práctica 4: carga el ply
