...
struct MallaTVT{
   ...
   //tabla de coordenadas de textura.Vector con num_vertices elementos.
   std::vector<Tupla2f> cte_ver;
};
...
//no une el ultimo perfil con el primero. 
//incluye creacion de la tabla de coordenadas de textura.
void CrearObjetoRevolucion2(MallaTVT *malla , int numero_perfiles, bool tapas); 

//modos con iluminacion
void VerISPlano( MallaTVT *malla );
