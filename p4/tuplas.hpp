...
// *********************************************************************
// tuplas con dos valores float
struct Tupla2f          // tupla con 2 valores floates que representan coordenas
{                       
   float coo[2] ;       
   
   inline Tupla2f( const float x, const float y );
   inline Tupla2f( const float coot[2] );
   Tupla2f() {};
} ;

// ---------------------------------------------------------------------
inline Tupla2f::Tupla2f( const float x, const float y)
{
   coo[X] = x ;
   coo[Y] = y ;
}
// ---------------------------------------------------------------------
inline Tupla2f::Tupla2f( const float coot[2] )
{
   coo[X] = coot[X] ;
   coo[Y] = coot[Y] ;
}
